      ...
      <div className="contact-inner-container">
        <div className="contact-leftside">
          <div className="contact-us">
            ...
            <p className="paragraph  contact-para">
              Class aptent taciti sociosqu ad litora torquent per conubia nostra
              <br /> per inceptos himenaeos nam nec ante sed lacinia.
              <br />
            </p>
          </div>
          <div className="contact-input-fields">
            <div className="fl-field">
              <input
                className="contact-input input-common"
                type="text"
            ...
            <div className="your-email">
              <input
                className="contact-email input-common"
                type="email"
            ...
            <div className="textarea-div">
              <textarea
                className="textarea input-common"
        ...
        <div className="contact-rightside">
          <div className="contact-content">
            ...
            <p className="paragraph  contact-right-para contact-place">
            ...
            <div className="contact-details contact-place common-space">
              ...
              <p>
                Email:{" "}
                <span className="span-color">contact@youroceanwpsite.com</span>
              </p>
              <p>
                Web: <span className="span-color">+111 22-33-444</span>
              </p>
            </div>
          </div>
        </div>
